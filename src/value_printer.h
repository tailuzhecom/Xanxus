...
class ValuePrinter {
	...
	void begin_block(string label);
		...
		operand call(vector<op_type> arg_types, op_type result_type,
			     ...
			     bool isVarArgs=false);
		operand call(op_type result_type, string fn_name,	// Zero-operand function 
			     bool is_global);
		operand call(op_type result_type, string fn_name, 	// One-operand function
			     bool is_global, const operand& arg1);
		operand call(op_type result_type, string fn_name, 	// Two-operand function
			     bool is_global, const operand& arg1, const operand& arg2);
